...
export default function Header() {
  return (
    <header id='site-header' className='_fixed _w-screen left-0 top-0'>
      <nav className='_dark:bg-gray-800 _border-gray-200 _px-4 _py-2.5 _lg:px-6 w-full bg-white pt-4'>
        <div className='_max-w-screen-xl _px-4 mx-auto flex flex-wrap items-center justify-between rounded-lg bg-white py-2.5 dark:bg-gray-800 lg:px-6'>
