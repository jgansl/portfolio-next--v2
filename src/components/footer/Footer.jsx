...
export default function Footer() {
  return (
    <footer className='rounded-t-lg bg-white p-4 antialiased shadow dark:bg-gray-800 sm:flex sm:items-center sm:justify-between sm:p-6 xl:p-8'>
      ...
      <ul className='flex gap-x-3 text-sm text-white'>
        <li>
